...
let navigate;
export default class ExpectingChild extends Component {
  constructor(props) {
    super(props);
        ...
        <KeyboardAwareScrollView>
          <Animatable.View animation="slideInRight">
            ...
            <View style={styles.btn}>
              ...
              >
                <Text style={styles.button_text}>Soon to be Parent </Text>
              </Button>
              <Button
                style={{
            ...
            <Button
                ...
                onPress={() => navigate("GrandParent")}
              >
                <Text style={styles.button_text}>Aunt/Uncle </Text>
              </Button>
              <Button
                style={{
                  backgroundColor: "#652E8B",
                  width: variable.deviceWidth / 3,
                  height: variable.deviceHeight / 5,
                  borderRadius: 20,
                  top: variable.deviceWidth / 20,
                ...
                onPress={() => navigate("GrandParent")}
              >
                <Text style={styles.button_text}>Grand-Parent </Text>
              </Button>
            </View>
            <View style={styles.btn}>
            <Button
