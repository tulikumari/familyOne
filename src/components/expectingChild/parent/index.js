      ...
      <Animatable.View animation="slideInRight">
        ...
        <KeyboardAwareScrollView>
            ...
            <View style={styles.btn}>
              <Button
                style={{
                    bottom:variable.deviceHeight / 10,
              ...
              >
                <Text style={styles.button_text}>Father </Text>
              </Button>
              <Button
                style={{
                bottom:variable.deviceHeight / 10,
                ...
                onPress={() => navigate("Family")}
              >
                <Text style={styles.button_text}>Mother </Text>
              </Button>
            </View>
...
const styles = {
  ...
  btn: {
    ...
    paddingVertical:(variable.deviceHeight / 3)+(variable.deviceHeight / 30),
  },
  text: {
