...
// ];
let navigate;
export class FamilyAddChildren extends Component {
  constructor(props) {
    super(props);
                            ...
                            <View style={{ backgroundColor: "#fff",width: variable.deviceWidth - 20, height:variable.deviceHeight/12 }}>
                              ...
                              >
                                <Text
                                  style={{
                                    ...
                                    justifyContent: "center",
                                    alignSelf: "center",
                                    marginTop: variable.deviceWidth / 20,
                                    color: "#fff"
                                  }}
                                >
                                  {answerList.gender}
                              ...
                              {!this.state.familychildren[indexs].is_expecting && answerList.date !== "" && (<View><Text
                                    style={{
                                      ...
                                      marginTop: variable.deviceHeight / 80,
                                      marginLeft: variable.deviceWidth / 50
                                    }}
                                  >
                                    Birth date:
                                  </Text>
...
FamilyAddChildren = connect(mapStateToProps)(FamilyAddChildren);
